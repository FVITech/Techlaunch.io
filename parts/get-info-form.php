...
<!--                <?php if ($limited != 'yes'){ ?>
			...
			<div class="form-input">
				...
				<select name="custom_field_8" id="custom_field_8">
		...
		<p class="disclosure">By clicking "Get Info", you agree for FVI School of Technology to contact you using our autodialer, text, pre-recorded message, via telephone or mobile device (including SMS and MMS) and email, even if your number is currently listed on any state, federal or corporate "Do Not Call list".</p>
	</div>
</div>
