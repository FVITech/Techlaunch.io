<?php $rootPath = '../'; 
$page = "coding-bootcamps-and-how-we-compare"; 
$meta_title="Coding Bootcamps and How We Compare";
$meta_key="";
$meta_desc="See how the FVI School of Technology program compares to the other coding training you’ve heard about. Learn why more students are earning Web Developing Diplomas at FVI School of Technology.";    
        ...
        <div class="container">
            ...
            <div class="content">
                <div class="text-box">
                    ...
                    <p>See how the FVI School of Technology program compares to the other coding training you’ve heard about.</p>
                </div>
                <?php
                    $classes = "on-page";
        ...
        <div class="container">
            <div class="split-2">
                ...
                <div class="split-box text">
                    ...
                    <p>We are centrally located in <a href="<?= $rootPath ?>campus-locations/">Miami</a> at Mall of the Americas on Flagler Street and Palmetto Expressway.</p>
                </div>
                <div class="split-box image-container">
