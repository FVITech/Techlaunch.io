        ...
        <div class="container">
            <div class="split-2">
                <div class="split-box">
                    ...
                    <br>
                    <p class="our-programs">Our programs are designed to get you in a career fast, with most designed to be completed in 9 months. Along with an excellent education, our career services team is there to help you prepare for and find a terrific career opportunity.</p>
                </div>
                <div class="split-box">
                    <?php
                        $classes = "on-page";
        ...
        <div class="container">
            <div class="split-2">
                ...
                <div class="split-box text">
                    ...
                    <p>Choose between two convienent locations.</p>
                </div>
                <div class="split-box image-container">
