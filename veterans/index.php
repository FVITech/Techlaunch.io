...
$meta_key="";
$meta_desc="The Coding Bootcamp for Veterans is now open!  Get the training you need with our structured programs. Click Here To Learn More About FVI School of Technology Veteran Coding Classes ";    
...
<body>
    ...
    <section>
        <div class="container">
            ...
            <p>At FVI School of Technology we’re dedicated to providing career education and training to members of the military, both past and present, as well as their dependents. Our programs are designed to help you get the training and skills you need so you can land your dream job in the tech industry.</p>
            <p>You sacrificed for our country, and at FVI School of Technology we think that effort should be rewarded. That’s why, when you enter one of our programs, you’ll receive:</p>
            <ul>
            ...
            <p>The FVI School of Technology team provides more than an education – we’ve committed to seeing you succeed, which is why, when you become a FVI School of Technology student, we’ll arrange for a student services support team member and a career services support team member to work with you so you can reach your training goals and feel prepared for new career opportunities.</p>
