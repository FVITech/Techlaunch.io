...
<body>
    ...
    <section class="" id="lily-cantillo">
        <div class="container">
            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/sOfvKZQ3Xp4?ecver=2<?php echo $options ?>" frameborder="0"></iframe>
            </div>
            <div class="">
                <h3 class="author">Lilianne Cantillo - <span class="title">Web Developer Student</span></h3>
    ...
    <section class="" id="peter-vegliante">
        <div class="container">
            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/GHzKGGoIgMo?ecver=2<?php echo $options ?>" frameborder="0"></iframe>
            </div>
            <div class="">
                <h3 class="author">Peter Vegliante - <span class="title">Web Developer Student</span></h3>
    ...
    <section class="" id="frank-veloz">
        <div class="container">
            <div class="video-container">
                <iframe src="https://www.youtube.com/embed/TqSNjcM-KrE?ecver=2<?php echo $options ?>" frameborder="0"></iframe>
            </div>
            <div class="">
                <h3 class="author">Frank Veloz - <span class="title">Web Developer Student</span></h3>
    ...
    <section class="" id="yasiel-sanchez">
        <div class="container">
            <img src="<?php echo $rootPath ?>images/people/yasiel-sanchez-caleo.jpg" alt="Yasiel Sanchez Caleo, Techlaunch @ FVI student">
            <div class="">
                <h3 class="author">Yasiel Sanchez Caleo - <span class="title">Web Developer Student</span></h3>
