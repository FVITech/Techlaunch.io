    ...
    <section class="syllabus">
        <div class="container">
            <div class="content intro-content switchable">
                <h3>Introduction content in Syllabus section</h3>
                ...
                <div class="split-2">
                    <div class="split-box">
                        <div class="item appear">
                            <p>Arroz con mango croquetas croquetica, metromover traffic souwesera civic center sint voluptate westchester Allapattah que cute qui guateber</p>
                        </div>
                        <div class="item appear">
                            <p>Arroz con mango croquetas croquetica, metromover traffic souwesera civic center sint voluptate westchester Allapattah que cute qui guateber</p>
                        </div>
