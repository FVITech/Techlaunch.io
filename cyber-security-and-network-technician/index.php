...
<body>
    ...
    <section class="students-success">
        <h2 class="section-title">student's success</h2>
        <div class="container">
    ...
    <section class="job-info">
        <div class="container">
            <h2 class="section-title">what kind of job can i get as a graduate?</h2>
            <p>The <strong>Web Developer Program</strong> from Techlaunch at FVI will prepare graduates to develop practical skills and knowledge needed or entry-level career opportunities in areas involving sotware design and development, systems analysis, programming, process design and management, and other areas related to computer software production and deployment.</p>
            <p>The fast growth in web and mobile development, combined with the increasing use of software, continues to create <strong>strong demand for software developers</strong>. The career services team at FVI will work with you to provide internships during training and upon graduation assist you in finding a great career as a web developer. FVI maintains strong working relationships with top companies in the area so we can match your passion and ability to career opportunities.</p>
            <div class="image-section">
                <div class="left"></div>
                <div class="right">
                    <h3>will i obtain any certifications?</h3>
