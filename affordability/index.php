<?php $rootPath = '../'; $page = "affordability"; include('../parts/head.php'); ?>
<body>
    ...
    <section>
        <div class="container">
            <h2 class="section-title">real cost calculator</h2>
    ...
    <section class="net-price-calculator">
        <div class="container">
